  ...
  >
    ...
    >
      <template slot-scope="scope">
        <el-input v-model="scope.row.key" clearable placeholder="Key" />
      </template>
    </el-table-column>
    ...
    >
      <template slot-scope="scope">
        <el-input v-model="scope.row.value" clearable placeholder="Value" />
      </template>
    </el-table-column>
    ...
    >
      <template slot-scope="scope">
        <el-input v-model="scope.row.desc" clearable placeholder="变量简要描述" />
      </template>
    </el-table-column>
