<template>
  <div>
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <span v-text="scope.row.time.duration.toFixed(3)+' 秒'" />
        </template>
      </el-table-column>
          ...
          <template slot-scope="props">
            <el-tabs>
              ...
              <el-tab-pane v-if="props.row.meta_data.response.content !== null" label="Content">
                <pre class="code-block" v-text="handleContent(props.row.meta_data.response.content)" />
              </el-tab-pane>
              ...
              <el-tab-pane v-if="props.row.meta_data.validators.length !== 0" label="Validators">
                <pre class="code-block" v-html="props.row.meta_data.validators" />
              </el-tab-pane>
