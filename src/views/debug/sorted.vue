      ...
      >
        ...
        >
          <template slot-scope="scope">
            ...
            <div v-else>
              <el-input v-model="scope.row.name" placeholder="请填写模板名称" />
            </div>
          </template>
        </el-table-column>
        <el-table-column
...
export default {
  ...
  methods: {
    ...
    currentRow(current, oldV) {
      console.log('this is new:' + JSON.stringify(current))
      this.oldStep = oldV
      console.log('this is old:' + JSON.stringify(oldV))
    },
