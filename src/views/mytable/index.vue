  ...
  <div class="table">
    <div class="container">
      <div class="handle-box">
        ...
        <el-select v-model="select_cate" placeholder="筛选省份" class="handle-select mr10" value="">
      ...
      <el-table ref="multipleTable" :data="data" border class="table" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="category" label="所属模块" width="120" />
        <el-table-column prop="body" label="请求主体" width="120" />
